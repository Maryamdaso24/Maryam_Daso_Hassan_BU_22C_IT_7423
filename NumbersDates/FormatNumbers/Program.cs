...
Console.WriteLine($"{sales[0], 12:C0} {sales[1], 12:C0} {sales[2], 12:C0} {sales[3]}");
Console.WriteLine("International Sales: ");
Console.WriteLine($"{intlMixPct[0], 12:P0} {intlMixPct[1], 12:P0} {intlMixPct[2], 12:P0} {intlMixPct[3]}");
